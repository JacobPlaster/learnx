<?php
  ...
  $SERVER_CFG['PORT'] = "80";
  $SERVER_CFG['REDIS_ENABLED'] = false;
  // Databse
  ...
  $SERVER_PATH['inserts-footer'] = $SERVER_PATH['inserts'].'/footer.php';
  ...
  // dynamic URLS
  $SERVER_URL['user_dashboard'] = $_SERVER['DOCUMENT_ROOT']."/users/dashboard.php";
 ?>
